...
>((props, forwardedRef) => {
  ...
  return (
    <div
      role="group"
      className="relative isolate flex items-center gap-2 px-3 py-2 md:grow"
    >
      <input
        {...restProps}
        ref={forwardedRef}
        type="radio"
        id={inputId}
        className="border-muted-6 ring-focus checked:border-primary-7 checked:bg-primary-4 peer absolute inset-0 -z-10 cursor-pointer appearance-none rounded border outline-none ring-offset-2 focus-within:ring-2"
      />
